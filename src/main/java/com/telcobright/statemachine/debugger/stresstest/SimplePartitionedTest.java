...
/**
 * Simplified test for partitioned-repo persistence with rehydration
 * Uses existing event classes to avoid compilation issues
 */
public class SimplePartitionedTest {
    ...
    public static void main(String[] args) throws Exception {
        System.out.println("\n" + "=".repeat(80));
        System.out.println("   SIMPLIFIED PARTITIONED-REPO TEST (1 MILLION MACHINES)");
    ...
    private static void runTest() throws Exception {
        ...
        stateCount.put("OFFLINE", new AtomicInteger(0));
